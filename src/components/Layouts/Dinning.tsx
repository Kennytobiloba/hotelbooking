...
const Dinning = () => {
  return (
    <div className="w-[95%] md:w-[90%] mx-auto mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10 md:mt-20 gap-6">
        <div>
          <h1 className="text-[26px] md:text-[38px] leading-[34px] md:leading-[52px] font-playwrite font-bold text-black">
            Specially crafted meal, served by a personal butler.
          </h1>
        </div>
        <div>
          <p className="text-[14px] md:text-[16px] leading-[24px] md:leading-[26px] mb-4 font-roboto text-gray-800">
          ...
          <button className="text-yellow mt-4 font-roboto capitalize border border-yellow px-4 sm:px-6 py-2 text-[14px] md:text-[16px]">
            Discover more
          </button>
        </div>
      </div>
